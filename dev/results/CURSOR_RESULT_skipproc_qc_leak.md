...
|--------------|---------------------|
| Auto FWHM limit | **5.045 px** (`median 4.97 + 1.5*sigma_MAD 0.0496`; k=1.5 from `config.json`) |
...
|------|-----------|------|---------------------------|
| **(a) qc_metrics.csv / VY_FWHM header** | `_qc_fwhm_elongation` on **full calibrated frame** (photutils segmentation, semimajor/minor sigma) | `pipeline.py` ~15901+ | **3.21-3.77 px**, median **3.48**; frame 001 = **3.239** |
