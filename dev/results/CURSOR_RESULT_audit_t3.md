...
| **Threshold** | `masterstar_dao_threshold_sigma` **2.1 ? 3.8** (`config.json`, `config.py`, registry help) - targets ~175 ADU at sigma_pp?46 |
| **Tests** | `test_preprocess_sky_surface.py` (P-10), `test_dao_sigma_pp_estimator.py` (sigma_pp) |
...
| Quantity | P-10 only (wrong) | P-10 + sigma_pp + 3.8? (this bundle) |
|----------|-------------------|----------------------------------|
