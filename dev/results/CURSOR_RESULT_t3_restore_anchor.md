...
|--------|--------|-----------|
| DAO pass-1 sim | **2579** | 2500-3000 band [OK] (429 logged 2816; ~237 gap documented) |
| Smooth residual p99 | **173 ADU** | < 200 ADU [OK] (oracle ~52 ADU) |
| Frame median Delta | +0.56 ADU | meta sky ~1478 is Labbe annulus, not frame median |
