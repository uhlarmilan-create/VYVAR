...
"Fin-lna valida?n- tabu?ka VYVAR (draft_310, BO CVn pole)" in `docs/VYVAR_JOURNAL.md`
...
## PUSH - 2026-07-18 (Milan-authorized)
...
- `--full`: **not required** - no commit touches `src_py/` science-path files (stack is docs +
