...
| Background2D | `box_size ? 8�FWHM` (odd, 16�256), `filter_size=3`, `MADStdBackgroundRMS` |
...
| Stage | sigma_pp med | bkg2d_rms med | actual_scatter med | ratio ?_pp | ratio bkg2d |
|-------|-------------:|--------------:|-------------------:|-----------:|------------:|
...
| frame | VY_FWHM* | align | dx_frac | dy_frac | sigma_pp | bkg2d_rms | thr 3.8�?_pp | thr 3.8�bkg2d |
|-------|---------:|-------|--------:|--------:|---------:|----------:|-------------:|--------------:|
...
| Implied threshold (3.8�?_pp) | **15.6%** |
...
| frame | convolved_std | ?_pp | bkg2d | conv/?_pp | conv/bkg2d |
|-------|-------------:|-----:|------:|----------:|-----------:|
...
**Ratio spread:** conv/?_pp **13.6%**; conv/bkg2d **14.3%** � neither ratio is stable across candidates. Per-pixel estimators do not track convolved DAO significance uniformly (~0.39�0.45 of pixel ?).

---

## M4 � Pass-1 DAO counts (extreme ?_pp frames)

| frame | ?_pp | mode | threshold ADU | pass-1 DAO |
|-------|-----:|------|-------------:|-----------:|
| Light_005 (low ?_pp) | 44.93 | 3.8�?_pp | 170.7 | **2489** |
| Light_005 | 44.93 | 3.8�bkg2d | 172.8 | 2417 |
| Light_005 | 44.93 | anchor abs | 175.4 | 2340 |
| Light_003 (mid-low) | 47.39 | 3.8�?_pp | 180.1 | 3004 |
| Light_003 | 47.39 | anchor abs | 175.4 | 3241 |
| Light_001 (high ?_pp) | 51.94 | 3.8�?_pp | 197.4 | 2426 |
| Light_001 | 51.94 | anchor abs | 175.4 | **3294** |

At fixed 3.8�?_pp: **2489�3004** (~21% spread). Background2D thresholds move counts ~3% vs ?_pp on same frame. Anchor absolute 175.4 ADU is **not** equivalent to 3.8�?_pp on these post-align frames (?_pp ~45�52 ? nominal threshold 171�197).
