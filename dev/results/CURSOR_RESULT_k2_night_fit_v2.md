...
Matrix k2_true - colour_spread - noise_mmag; non-detectable cells must refuse
...
| Draft 427 fixture | consistency and/or plausibility (items 3-4) |
...
- P1 golden 5/5
- `--full` OVERALL PASS - BYTE-IDENTICAL (core `3d26f469...` n=333; extended `6420f1da...` n=499; science-compare n_lc=166 failures=0)
