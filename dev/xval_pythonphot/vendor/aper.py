...
from . import pixwt
from . import mmm
# VYVAR vendor py3: np.asfarray and np.iterable removed in NumPy 2.0.
...
where, asarray, array, zeros, arange = np.where, np.asarray, np.array, np.zeros, np.arange
