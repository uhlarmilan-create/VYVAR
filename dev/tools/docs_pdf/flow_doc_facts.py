...
DOC_FUNCTIONS: list[tuple[str, str]] = [
    ...
    ("src_py/photometry_phase2a.py", "compute_aperture_correction"),
    ("src_py/photometry_lightcurve.py", "ensemble_normalize"),
    ("src_py/photometry_lightcurve.py", "compute_mag_calib_final"),
