...
| `observer_location_id` | 0 | - | basic | static | db_static | site | site | n/a | auto | Observer Location ID |
| `observer_location_name` |  | - | basic | static | db_static | site | site | n/a | auto | Observer Location Name |
| `observer_lon` | 14.6982547 | - | basic | static | db_static | site | site | n/a | auto | Observer Lon |
| `observer_name` | Unknown Observer | - | basic | static | db_static | site | site | n/a | auto | Observer Name |
...
| `masterflat_validity_days` | 200 | - | basic | static | config_runtime | rig | rig | c | auto | Masterflat Validity Days |

## qc

| key | default | range | tier | kind | owner | scope | scope_key | scope_group | widget | label |
|-----|---------|-------|------|------|-------|-------|-----------|-------------|--------|-------|
| `auto_fwhm_enabled` | True | - | advanced | static | config_runtime | universal | none | n/a | custom | Auto FWHM Enabled |
...
| key | default | range | tier | kind | owner | scope | scope_key | scope_group | widget | label |
|-----|---------|-------|------|------|-------|-------|-----------|-------------|--------|-------|
| `alignment_detection_sigma` | 5.0 | - | advanced | static | config_runtime | universal | none | n/a | custom | Alignment Detection Sigma |
| `alignment_max_control_points` | 80 | - | expert | static | config_runtime | rig | rig_sampling | c | custom | Alignment Max Control Points |
| `alignment_max_stars` | 160 | 10 .. 5000 | advanced | static | config_runtime | universal | none | n/a | custom | Alignment Max Stars |

## detection

| key | default | range | tier | kind | owner | scope | scope_key | scope_group | widget | label |
|-----|---------|-------|------|------|-------|-------|-----------|-------------|--------|-------|
| `blind_img_select_mode` | per_cell | - | expert | static | config_runtime | session | frame | n/a | custom | Blind Img Select Mode |
| `blind_img_star_budget` | 80 | - | expert | static | config_runtime | universal | none | n/a | custom | Blind Img Star Budget |
| `blind_use_rig_prior` | True | - | expert | static | config_runtime | rig | rig | a | custom | Blind Use Rig Prior |
| `blind_verify_early_accept` | 30 | - | expert | static | config_runtime | universal | none | n/a | custom | Blind Verify Early Accept |
| `blind_verify_early_floor` | 0 | - | expert | static | config_runtime | universal | none | n/a | custom | Blind Verify Early Floor |
...
| `blind_verify_top_n` | 15 | - | expert | static | config_runtime | universal | none | n/a | custom | Blind Verify Top N |
| `catalog_query_max_rows` | 15000 | 1000 .. 500000 | expert | static | config_runtime | universal | none | n/a | auto | Catalog Query Max Rows |
...
| `masterstar_prematch_peak_sigma_floor` | 1.8 | 0.5 .. 6 | advanced | static | config_runtime | universal | none | n/a | custom | Masterstar Prematch Peak Sigma Floor |
| `masterstar_quality_crowded_n_cat_min` | 800 | - | expert | static | config_runtime | universal | none | n/a | custom | Masterstar Quality Crowded N Cat Min |
...
| `variability_comp_floor_factor` | 1.5 | - | expert | static | config_runtime | universal | none | n/a | auto | Variability Comp Floor Factor |
| `variability_mag_limit` | 14.5 | - | expert | static | config_runtime | universal | none | n/a | auto | Variability Mag Limit |
| `variability_min_amplitude_mag` | 0.01 | - | expert | static | config_runtime | universal | none | n/a | auto | Variability Min Amplitude Mag |
| `variability_min_frames` | 30 | - | expert | static | config_runtime | universal | none | n/a | auto | Variability Min Frames |
| `variability_min_frames_frac` | 0.5 | 0.05 .. 0.99 | expert | static | config_runtime | universal | none | n/a | auto | Variability Min Frames Frac |
...
| `variability_vdi_z_threshold` | 3.0 | - | expert | static | config_runtime | universal | none | n/a | auto | Variability VDI Z Threshold |
| `verify_mag_limit` | 14.0 | 8 .. 18 | expert | static | config_runtime | universal | none | n/a | auto | Verify Mag Limit |
| `vsx_out_of_scope_types` | [] | - | basic | static | config_runtime | universal | none | n/a | auto | VSX Out Of Scope Types |
...
| `cog_sat_frac` | 0.85 | - | expert | static | config_runtime | universal | none | n/a | custom | COG Sat Frac |
...
| `neighbor_sub_max_target_undermag` | 0.2 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Max Target Undermag |
| `neighbor_sub_min_recovered_snr` | 5.0 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Min Recovered SNR |
| `neighbor_sub_nn_contam_dmag` | 2.5 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub NN Contam Dmag |
| `neighbor_sub_refuse_sep_fwhm` | 0.8 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Refuse Sep FWHM |
| `neighbor_sub_regime_dmag_min` | 2.5 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Regime Dmag Min |
| `neighbor_sub_regime_sep_max` | 1.1 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Regime Sep Max |
| `neighbor_sub_residual_rms_max` | 150.0 | - | expert | static | config_runtime | universal | none | n/a | custom | Neighbor Sub Residual RMS Max |
| `nonlinearity_fwhm_ratio` | 1.25 | 1.01 .. 3 | advanced | static | config_runtime | universal | none | n/a | auto | Nonlinearity FWHM Ratio |
| `nonlinearity_peak_percentile` | 20.0 | 0 .. 50 | advanced | static | config_runtime | universal | none | n/a | auto | Nonlinearity Peak Percentile |
| `per_frame_sat_min_clean_frac` | 0.5 | 0.1 .. 1 | advanced | static | config_runtime | universal | none | n/a | custom | Per Frame Sat Min Clean Frac |
...
| `psf_neighbor_sub_enabled` | False | - | expert | static | config_runtime | universal | none | n/a | custom | PSF Neighbor Sub Enabled |
...
| `save_lightcurve_png` | False | - | advanced | static | config_runtime | universal | none | n/a | auto | Save Lightcurve Png |
| `savgol_detrend_enabled` | False | - | advanced | static | config_runtime | universal | none | n/a | custom | Savgol Detrend Enabled |
...
| `temporal_binning_enabled` | False | - | advanced | static | config_runtime | universal | none | n/a | custom | Temporal Binning Enabled |
...
| key | default | range | tier | kind | owner | scope | scope_key | scope_group | widget | label |
|-----|---------|-------|------|------|-------|-------|-----------|-------------|--------|-------|
| `check_select_rms_floor` | 0.0001 | 0 .. 0.01 | expert | static | config_runtime | universal | none | n/a | auto | Check Select RMS Floor |
| `check_star_min_epochs` | 5 | - | advanced | static | config_runtime | universal | none | n/a | auto | Check Star Min Epochs |
| `comp_qa_enabled` | True | - | expert | static | config_runtime | universal | none | n/a | auto | Comp Qa Enabled |
| `comp_trust_min_comps` | 5 | - | advanced | static | config_runtime | universal | none | n/a | auto | Comp Trust Min Comps |
| `lc_quality_min_frames` | 20 | - | advanced | static | config_runtime | universal | none | n/a | auto | Lc Quality Min Frames |
| `lc_quality_min_normal_frac` | 0.5 | 0.1 .. 1 | advanced | static | config_runtime | universal | none | n/a | auto | Lc Quality Min Normal Frac |
| `lc_quality_short_min_frames` | 3 | - | advanced | static | config_runtime | universal | none | n/a | auto | Lc Quality Short Min Frames |
| `sparse_trust_T_green` | 1.5 | - | expert | static | config_runtime | universal | none | n/a | auto | Sparse Trust T Green |
| `sparse_trust_T_red` | 4.0 | - | expert | static | config_runtime | universal | none | n/a | auto | Sparse Trust T Red |
| `sparse_trust_X2_RED` | 0.0004 | - | expert | static | config_runtime | universal | none | n/a | auto | Sparse Trust X2 RED |
| `trust_flag_enabled` | True | - | expert | static | config_runtime | universal | none | n/a | auto | Trust Flag Enabled |
...
| `k2_fit_enabled` | False | - | expert | static | config_runtime | universal | none | n/a | custom | K2 Fit Enabled |
| `k2_fit_lit_factor` | 4.0 | - | expert | static | config_runtime | universal | none | n/a | custom | K2 Fit Lit Factor |
| `k2_fit_min_detectability` | 3.0 | - | expert | static | config_runtime | universal | none | n/a | custom | K2 Fit Min Detectability |
| `k2_mode` | literature | - | advanced | static | config_runtime | site | site | n/a | custom | K2 Mode |
...
| `hrd_color_field_enabled` | True | - | expert | static | config_runtime | universal | none | n/a | custom | HRD Color Field Enabled |
| `hrd_color_highlight_mode` | soft | - | expert | static | config_runtime | universal | none | n/a | custom | HRD Color Highlight Mode |
| `hrd_color_saturation` | 0.85 | 0 .. 1 | expert | static | config_runtime | universal | none | n/a | custom | HRD Color Saturation |
| `hrd_color_white_point` | field_median | - | expert | static | config_runtime | universal | none | n/a | custom | HRD Color White Point |
| `hrd_dsc_confirm_prob` | 0.9 | 0.5 .. 1 | expert | static | config_runtime | universal | none | n/a | custom | HRD DSC Confirm Prob |
| `hrd_enrich_max_candidates` | 20 | 1 .. 100 | expert | static | config_runtime | universal | none | n/a | custom | HRD Enrich Max Candidates |
| `hrd_enrich_tap_timeout_s` | 20.0 | 5 .. 120 | expert | static | config_runtime | universal | none | n/a | custom | HRD Enrich Tap Timeout S |
| `hrd_max_per_category` | 3 | 1 .. 20 | expert | static | config_runtime | universal | none | n/a | custom | HRD Max Per Category |
| `hrd_min_per_net` | 4 | 0 .. 20 | expert | static | config_runtime | universal | none | n/a | custom | HRD Min Per Net |
| `hrd_nss_category_enabled` | False | - | expert | static | config_runtime | universal | none | n/a | custom | HRD NSS Category Enabled |
| `hrd_online_enrich_enabled` | True | - | expert | static | config_runtime | universal | none | n/a | custom | HRD Online Enrich Enabled |
| `hrd_parallax_min_mas` | 0.15 | 0 .. 10 | expert | static | config_runtime | universal | none | n/a | custom | HRD Parallax Min Mas |
| `hrd_parallax_snr_min` | 5.0 | 1 .. 20 | expert | static | config_runtime | universal | none | n/a | custom | HRD Parallax SNR Min |
| `hrd_simbad_enrich_enabled` | True | - | expert | static | config_runtime | universal | none | n/a | custom | HRD Simbad Enrich Enabled |
...
| key | default | range | tier | kind | owner | scope | scope_key | scope_group | widget | label |
|-----|---------|-------|------|------|-------|-------|-----------|-------------|--------|-------|
| `per_frame_mp_reserve_ram_gb` | 1.5 | - | expert | static | config_runtime | universal | none | n/a | hidden | Per Frame MP Reserve RAM Gb |
| `qc_preprocess_workers` | 1 | - | expert | resolved | internal | universal | none | n/a | hidden | QC Preprocess Workers |
