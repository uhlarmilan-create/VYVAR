...
**Status:** QUEUED (MASTERSTAR stack). **Aperture A-1:** **CONFIRMED** at **48.0 +/- 5.7 mmag**
(Step 1f). T4 ratio open (FAIL). Harness: `dev/tools/closure_step1f_differential_aperture.py`.
