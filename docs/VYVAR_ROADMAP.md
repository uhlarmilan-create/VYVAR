...
**Status:** QUEUED (MASTERSTAR stack). **Aperture A-1:** **CONFIRMED** (verdict); Step 1g F1
done; G6 fail -- exact magnitude open. Harness: `closure_step1f_differential_aperture.py`.
