...
| **7** | **C-1** | Admission gate: predicted per-epoch SNR (`g_lim_*` + Labbé sigma_bkg_ap) | 7, 8 | QUEUED | -- |
...
| 16 | D5-1 aperture provenance columns | 5 | **FIXED** | Stage 1.2 proc CSV columns |
