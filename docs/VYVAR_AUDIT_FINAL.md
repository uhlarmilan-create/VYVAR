...
Predicted fixed-radius bias at high FWHM not dominant on anchor because radii track per-frame FWHM.
...
**Next work item:** Closure Step 1 (**A-1** -- frame selection metric for stacked MASTERSTAR).
