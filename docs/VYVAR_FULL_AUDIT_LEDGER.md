...
| G2-F005 | **MED** | L4 | `photometry_core.py:8717` | Log claims catalog_only targets are skipped without DAO on masterstar while downstream LC/export paths may still imply photometry ran. | Operator logs must match the actual branch taken for catalog_only targets. |
