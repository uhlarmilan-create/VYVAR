...
| D10-1 | 4 | transforms | C?FIXED | - | unfiltered?CR band | closure #18 | FIXED Milan decision. **Annotate 2026-09-16 (DOD-04):** VAL-02 colour term c = +140 mmag/mag vs Johnson V on the PSF path (n=95 core) - input to the CV/CR decision | CLOSED |
