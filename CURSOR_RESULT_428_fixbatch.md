...
| FWHM @ bin2 | 6.234″ (2.3976 px × 2.6″/px) |
| Nearest-Gaia sep p50 | 80.973″ |
| p90 / p95 / max | 132.478″ / 149.915″ / 198.664″ |
| Within 1× / 1.5× / 2× FWHM | 0 / 4 / 5 of 2724 |
...
| F-428-TAP | **FIXED** | 3× TAP attempts (5s/15s backoff); `hrd_enrich_tap_timeout_s` in AppConfig/config.json/PARAMS; `_hrd_cache/summary.json` skip metadata; PDF one-line note |
