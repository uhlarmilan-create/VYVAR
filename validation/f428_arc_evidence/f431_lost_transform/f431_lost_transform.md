...
| Image | DAO pass-1 (σ=2.1, FWHM=2.5) |
|-------|------------------------------|
...
→ The transform that matters is the **order-2 surface**, which raises σ-clipped sky std
...
Order-2 coefficients `(1, y, y², x, xy, x²)` ≈
...
- Phase correlation (256² center): shift **(0,0)**, peak 0.89 — **not** a large rigid offset.
...
**Not:** constant-only pedestal; integer-shift alignment; aggressive 8×MAD clip.
