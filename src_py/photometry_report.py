...
class _PhotometryReportBuilder:
    ...
    def _report_abbreviations(self, c: "canvas.Canvas") -> None:
        ...
        pairs = [
            ...
            ("n_good_comp", "Phase-2A ensemble pool: comps with stability quality good or suspect (summary column)"),
            ("n_clean", "comp_qa Sokolovsky LOO: comps not flagged for this target (trust gate metric)"),
