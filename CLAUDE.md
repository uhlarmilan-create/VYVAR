...
- `docs/VYVAR_CONFIG_GUIDE_EN.md` / `docs/VYVAR_CONFIG_GUIDE_CZ.md` - plain-language guide to all 266 registered configuration parameters (config.json persists the durable subset) (EN + CZ)
