...
def render_settings_dashboard(
    ...
    *,
    ...
    with tab_paths:
        ...
        _detail_help(
            "BLIND_INDEX_PATH",
            phase="Blind astrometry / triangle matching (if enabled in pipeline).",
            used_in="Path to `gaia_triangles.pkl` from `build_gaia_blind_index.py`.",
            compute="Precomputed index — no runtime computation except loading.",
        )
        st.caption("Path to gaia_triangles.pkl (generated by build_gaia_blind_index.py script)")
