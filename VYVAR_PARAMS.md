...
**Summary:** 61 exposed · 126 intentionally-hidden · 23 config-only (no UI) · 2 UI references without config key
...
|-----|---------|-------------|-------------|---------|
| `alignment_detection_sigma` | 5.0 | — | ui_settings.py:79, ui_settings.py:332, ui_settings.py:335 | yes |
| `alignment_max_stars` | 160 | 10 … 5000 | ui_settings.py:79, ui_settings.py:318, ui_settings.py:321 | yes |
...
| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `masterdark_validity_days` | 80 | — | ui_settings.py:229, ui_settings.py:718 | yes |
| `masterflat_validity_days` | 524 | — | ui_settings.py:242, ui_settings.py:719 | yes |
...
| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `blind_verify_early_accept` | 30 | — | — | intentionally-hidden ⚠ not in config.json |
| `blind_verify_early_floor` | 0 | — | — | intentionally-hidden ⚠ not in config.json |
| `blind_verify_early_fraction` | 0.2 | 0.0 … 0.95 | — | intentionally-hidden ⚠ not in config.json |
| `blind_verify_enabled` | True | — | — | intentionally-hidden |
| `blind_verify_inmemory_catalog` | True | — | — | intentionally-hidden ⚠ not in config.json |
...
| `observer_alt_m` | 355.5 (dataclass 275.0) | — | — | no |
| `observer_code` | 'UMIA' (dataclass '') | — | — | no |
| `observer_lat` | 50.073658 (dataclass 50.1121658) | — | — | no |
| `observer_location_id` | 1 (dataclass 2) | — | — | no |
| `observer_location_name` | 'Dablice' (dataclass '') | — | — | no |
| `observer_lon` | 14.41854 (dataclass 14.6982547) | — | — | no |
...
| `blind_prefilter_min` | 4 | — | — | intentionally-hidden ⚠ not in config.json |
| `blind_scale_tol_frac` | 0.1 | 0.02 … 0.50 | — | no |
| `blind_use_rig_prior` | True | — | — | no |
| `verify_mag_limit` | 14.0 | 8.0 … 18.0 | — | intentionally-hidden ⚠ not in config.json |
...
| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `calibration_library_native_binning` | 1 | 1 … 16 | ui_settings.py:253, ui_settings.py:260, ui_settings.py:265 | yes |

## Paths / catalogs

| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `blind_index_path` | 'C:\\ASTRO\\python\\VYVAR\\GAIA_DR3\\gaia_triangles.pkl' | — | ui_settings.py:158, ui_settings.py:722 | yes |
| `blind_index_select_mode` | 'auto' | — | — | no |
| `blind_index_series` | 'C:\\ASTRO\\python\\VYVAR\\GAIA_DR3\\blind_index_series.json' | — | — | no |
| `catalog_query_max_rows` | 15000 | 1000 … 500_000 | — | no |
| `gaia_db_path` | 'C:\\ASTRO\\python\\VYVAR\\GAIA_DR3\\vyvar_gaia_dr3.db' (dataclass '') | — | ui_hrd.py:49, ui_settings.py:123, ui_settings.py:721 | yes |
| `vsx_local_db_path` | 'C:\\ASTRO\\python\\VYVAR\\VSX\\vyvar_vsx_local_v2.db' (dataclass '') | — | ui_aperture_photometry.py:1416, ui_masterstar_qa.py:595, ui_settings.py:173 | yes |
| `vsx_variable_targets_mag_limit` | 14.5 | — | ui_aperture_photometry.py:1358, ui_settings.py:212, ui_settings.py:217 | yes |
...
| `comp_max_delta_bprp` | 0.79 | 0.0 … 5.0 | ui_settings.py:597, ui_settings.py:754 | yes |
| `comp_max_slope_mmag_hr` | 5.0 | 0.0 … 500.0 | — | intentionally-hidden |
| `comp_tier1_bprp_limit` | 0.15 | 0.02 … 5.0 | ui_settings.py:568, ui_settings.py:750 | yes |
| `comp_tier1_weight` | 1.0 | 0.01 … 1.00 | ui_settings.py:602, ui_settings.py:605, ui_settings.py:755 | yes |
| `comp_tier2_bprp_limit` | 0.3 | 0.05 … 5.0 | ui_settings.py:576, ui_settings.py:751 | yes |
| `comp_tier2_weight` | 0.85 | 0.01 … 1.00 | ui_settings.py:609, ui_settings.py:612, ui_settings.py:756 | yes |
| `comp_tier3_bprp_limit` | 0.55 | 0.05 … 5.0 | ui_settings.py:583, ui_settings.py:752 | yes |
| `comp_tier3_weight` | 0.5 | 0.01 … 1.00 | ui_settings.py:616, ui_settings.py:619, ui_settings.py:757 | yes |
| `comp_tier4_bprp_limit` | 1.1 | 0.05 … 5.0 | ui_settings.py:590, ui_settings.py:753 | yes |
| `comp_tier4_weight` | 0.25 | 0.01 … 1.00 | ui_settings.py:623, ui_settings.py:626, ui_settings.py:758 | yes |
| `global_comp_pool_enabled` | True | — | — | intentionally-hidden |
| `phase01_comparison_exclude_gaia_extobj` | True | — | ui_select_stars.py:451, ui_select_stars.py:540, ui_settings.py:673 | yes |
| `phase01_comparison_exclude_gaia_nss` | True | — | ui_select_stars.py:450, ui_select_stars.py:539, ui_settings.py:669 | yes |
...
| `phase01_comparison_mag_bright_threshold` | 12.75 | 6.0 … 18.0 | ui_select_stars.py:443, ui_select_stars.py:531, ui_settings.py:537 | yes |
| `phase01_comparison_max_comp_rms` | 0.1 | 0.01 … 0.5 | ui_select_stars.py:447, ui_select_stars.py:536, ui_settings.py:642 | yes |
...
| `phase01_comparison_max_mag_diff_absolute` | 3.0 | 1.0 … 10.0 | ui_settings.py:554, ui_settings.py:749 | yes |
| `phase01_comparison_max_mag_diff_bright_floor` | 1.5 | 0.0 … 4.0 | ui_select_stars.py:444, ui_select_stars.py:532, ui_settings.py:544 | yes |
| `phase01_comparison_max_psf_chi2` | 50.0 | 1.0 … 500.0 | — | intentionally-hidden |
| `phase01_comparison_min_dist_arcsec` | 60.0 | 0.0 … 600.0 | ui_select_stars.py:448, ui_select_stars.py:537, ui_settings.py:649 | yes |
...
| `phase01_comparison_n_comp_max` | 8 | — | ui_select_stars.py:446, ui_select_stars.py:535, ui_settings.py:636 | yes |
| `phase01_comparison_n_comp_min` | 3 | — | ui_select_stars.py:446, ui_select_stars.py:534, ui_settings.py:630 | yes |
...
| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `democratic_detrend_enabled` | False | — | ui_settings.py:487, ui_settings.py:743 | yes |
| `democratic_sg_window_frac` | 0.5 | 0.05 … 0.95 | — | intentionally-hidden |
| `pytics_enabled` | True | — | ui_settings.py:476, ui_settings.py:741 | yes |
| `pytics_n_iter` | 5 | 1 … 20 | — | intentionally-hidden |
| `savgol_detrend_enabled` | False | — | ui_settings.py:482, ui_settings.py:742 | yes |
...
| `temporal_binning_enabled` | True | — | ui_settings.py:471, ui_settings.py:740 | yes |
...
| key | default | clamp/range | UI location | exposed |
|-----|---------|-------------|-------------|---------|
| `annulus_inner_fwhm` | 4.75 | 1.0 … 10.0 | ui_settings.py:77, ui_settings.py:424, ui_settings.py:427 | yes |
| `annulus_outer_fwhm` | 9.0 | 1.5 … 12.0 | ui_settings.py:77, ui_settings.py:431, ui_settings.py:434 | yes |
| `aperture_comp_factor` | 1.1 | 0.25 … 3.0 | ui_settings.py:461, ui_settings.py:739 | yes |
...
| `aperture_variable_factor` | 1.0 | 0.25 … 3.0 | ui_settings.py:452, ui_settings.py:738 | yes |
| `nonlinearity_fwhm_ratio` | 1.25 | 1.01 … 3.0 | ui_settings.py:498, ui_settings.py:501, ui_settings.py:737 | yes |
| `nonlinearity_peak_percentile` | 20.0 | 0.0 … 50.0 | ui_settings.py:491, ui_settings.py:494, ui_settings.py:736 | yes |
...
| `qc_after_calibrate_enabled` | True | — | ui_settings.py:78, ui_settings.py:274, ui_settings.py:275 | yes |
...
| `qc_max_hfr` | 5.0 | — | ui_settings.py:78, ui_settings.py:288, ui_settings.py:291 | yes |
| `qc_min_stars` | 10 | — | ui_settings.py:78, ui_settings.py:302, ui_settings.py:305 | yes |
