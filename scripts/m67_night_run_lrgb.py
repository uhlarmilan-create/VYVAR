...
def _post_platesolve_hook(draft_id: int, draft_dir: Path, _cfg, _pipeline) -> None:
    ...
    reps = presel.presel_draft(draft_id, gaia_db_path=FIELD_DB)
...
def main() -> int:
    ...
    sys.path.insert(0, str(_ROOT / "scripts"))
    import m67_crop_frames as crop  # noqa: E402
    import m67_phases_ac as m67  # noqa: E402
    ...
    try:
        ...
        params = NightRunParams(
            ...
            min_detected_stars=150,
            max_detected_stars=2500,
