...
| blind_index_path | str | "C:\\ASTRO\\python\\VYVAR\\GAIA_DR3\\gaia_triangles.pkl" | Path to blind plate-solve triangle hash index (``gaia_triangles.pkl``, from ``build_gaia_blind_index.py``). |
