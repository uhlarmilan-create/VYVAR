...
- config.py, hrd_analysis.py, ui_hrd.py, photometry_report.py
- scripts/todo12_hrd_validate.py, tests/test_hrd_extreme.py
(docs commit pending)
- docs/config_schema.md, docs/VYVAR_PARAMS.md, docs/VYVAR_STATE.md, docs/VYVAR_JOURNAL.md, docs/VYVAR_ROADMAP.md
- CURSOR_RESULT_todo12d_hrd.md
